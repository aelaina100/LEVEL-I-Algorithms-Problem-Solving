...
// solving this example, SHOULD be done utilizing Arrays Instead of structures
...
// 
// #2: The optimized solution ( But still primitive as compared to solving the example with ARRAYS)
struct stMarks
{
	float Mark1;
	float Mark2;
