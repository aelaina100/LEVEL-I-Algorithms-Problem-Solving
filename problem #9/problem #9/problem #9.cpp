...
/* Solution:
   ...
   NOTE: FOR THE SOLUTION BELOW YOU MAY NEED BETTER NAMINTG FOR FUNCTIONS / PROCEDURES AS THIS WAS INDEED THE FIRST ATTEMPT EVER IN SOLVING THIS PROBLEM ( Plus I may need 
   some editing for the comment just before I make a final release for this repository !!)
*/
...
int main()
{
    // Three variables are to be declared and initialized via reading user input
