...
{
    stCircleInfo CircleInfo; // The next natural step of declaring a normal variable (one record) of the structure user-defined data type what's returned.
...
int main()
{
    ...
    stCircleInfo CircleInfo = ReadCircleInfo();   // the name of the variable could be any other one.
